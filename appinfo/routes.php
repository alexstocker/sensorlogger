...
return array(
	'routes' => array(
		...
		array('name' => 'sensorlogger#deleteDeviceType', 'url' => 'deleteDeviceType/{id}', 'verb' => 'POST'),
		array('name' => 'sensorlogger#deleteDeviceGroup', 'url' => 'deleteDeviceGroup/{id}', 'verb' => 'POST'),
		array('name' => 'sensorlogger#deleteDataType', 'url' => 'deleteDataType/{id}', 'verb' => 'POST'),
